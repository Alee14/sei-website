            ...
            <div>
                ...
                <ul>
                    <li className="p-6 sm:px-40 px-10 bg-green-950">
                        ...
                        <p>Take similar precautions to those you would take in Southeastern Islands.</p>
                    </li>
                    <li className="p-6 sm:px-40 px-10 bg-yellow-700">
                        ...
                        <p><b className="font-semibold"> IMPORTANT:</b> The two levels below are official Government of Southeastern Islands Travel Advisories and are issued when the safety and security of Alurians travelling or living in the country or region may be at risk.</p>
                    </li>
